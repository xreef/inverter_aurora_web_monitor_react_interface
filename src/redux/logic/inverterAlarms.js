...
import { INVERTER_ALARMS_FETCH, INVERTER_ALARMS_FETCH_CANCEL, inverterAlarmsFetchFulfilled,
    inverterAlarmsFetchRejected, INVERTER_ALARMS_FETCH_REJECTED, INVERTER_ALARMS_FETCH_FULFILLED } from '../actions/inverterAlarms';
...
const inverterAlarmsFetchLogic = createLogic({
    ...
    process({ getState, action }, dispatch, done) {
        return axios.get(`http://${MICROCONTROLLER_ADRESS}/${INVERTER_ALARMS_ENDPOINT}`)
            .then(resp => {
